...
async def test_langgraph_output_structure_matches_original():
    ...
    original_result = await original_service.generate_diagram_from_description(description)
    ...
    langgraph_result = await langgraph_service.generate_diagram_from_description(description)
...
async def test_three_tier_fallback_behavior():
    ...
    result_langchain = await service_langchain.generate_diagram_from_description(description)
    ...
    result_original = await service_original.generate_diagram_from_description(description)
